    ...
    <section ref={ref} id="home">
      ...
      >
        {/* <div className="text-center">
          <p className="text-xl">
            Hello, I'm <span className="font-bold">Prapti</span>.
          </p>
          <p className="text-xl">
        ...
        <div className="text-center">
          <p className="text-3xl font-semibold">
            Hello, I'm <span className="font-bold">Prapti Saxena</span>.
          </p>
          ...
          <p className="text-xl">
            You can reach me at{" "}
            <span className="font-semibold">praptisaxena009@gmail.com</span>.
          </p>
        </div>
      </motion.h1>
      <motion.div
